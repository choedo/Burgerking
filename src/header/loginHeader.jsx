        ...
        <div className={styled.login_header}>
            <div className={styled.login_header_in}>
                <div className={styled.login_top}>
                    <ul>
                        <li><Link to="/" className={styled.topLink}>브랜드홈</Link></li>
                        <li><Link to="/login" className={styled.topLink}>로그인</Link></li>
                        <li><Link to="/" className={styled.topLink}>고객센터</Link></li>
                    </ul>
                </div>

                <div className={styled.login_menu}>
                    <div className={styled.login_logo}>
                        <Link to="/"><h2>버거킹</h2></Link>
                    </div>
                    <div className={styled.login_btn}>
                        <p><Link to="/join" className={styled.joinBtn}>회원가입</Link></p>
                    </div>
                </div>
            </div>
        </div>
