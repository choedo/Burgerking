                        ...
                        <ul className={styled.f_mn}>
                            <li>
                                ...
                                <ul className={styled.f_sub_mn}>
                                    <li><Link to="/Burgerking/menu/special" className={styled.f_sub_mn_link}>스페셜&할인팩</Link></li>
                                    <li><Link to="/Burgerking/menu/premium" className={styled.f_sub_mn_link}>프리미엄</Link></li>
                                    <li><Link to="/Burgerking/menu/whopper" className={styled.f_sub_mn_link}>와퍼</Link></li>
                                    <li><Link to="/Burgerking/menu/junior" className={styled.f_sub_mn_link}>주니어&버거</Link></li>
                                    <li><Link to="/Burgerking/menu/allday" className={styled.f_sub_mn_link}>올데킹&치킨버거</Link></li>
                                    <li><Link to="/Burgerking/menu/side" className={styled.f_sub_mn_link}>사이드</Link></li>
                                    <li><Link to="/Burgerking/menu/drink" className={styled.f_sub_mn_link}>음료&디저트</Link></li>
                                    <li><Link to="/Burgerking/menu/dogper" className={styled.f_sub_mn_link}>독퍼</Link></li>
                                </ul>
                            </li>
                            <li>
                                <p className={styled.f_main_mn_link}>매장소개</p>
                                <ul className={styled.f_sub_mn}>
                                    <li><Link to="/Burgerking/search" className={styled.f_sub_mn_link}>매장찾기</Link></li>
                                </ul>
                            </li>
                            <li>
                                <p className={styled.f_main_mn_link}>이벤트</p>
                                <ul className={styled.f_sub_mn}>
                                    <li><Link to="/Burgerking/event/all" className={styled.f_sub_mn_link}>이벤트</Link></li>
                                </ul>
                            </li>
                            <li>
                                <p className={styled.f_main_mn_link}>브랜드스토리</p>
                                <ul className={styled.f_sub_mn}>
                                    <li><Link to="/Burgerking/brandstory/brand/story" className={styled.f_sub_mn_link}>BRAND</Link></li>
                                    <li><Link to="/Burgerking/brandstory/whopper/real" className={styled.f_sub_mn_link}>WHOPPER</Link></li>
                                    <li><Link to="/Burgerking/brandstory/comm/ad" className={styled.f_sub_mn_link}>COMM.</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
